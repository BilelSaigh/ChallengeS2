                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1"><?=$infos["firstname"]." ". $infos["lastname"]?></a>
                            ...
                            <td>
                                <?php if($infos["status"] == "1") : ?>
                                    <div class="badge badge-light-success fw-bold">Verify</div>
                                <?php else :?>
                                    <div class="badge badge-light-danger fw-bold">Unverified</div>
                                <?php endif;?>

                            </td>
                            <td><?=$infos["date_inserted"]?></td>
                            <td class="text-end">
