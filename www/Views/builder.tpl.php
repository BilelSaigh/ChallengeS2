...
<!--        <link rel="stylesheet" type="text/css" href="../Views/Dash/theme/plugins/bootstrap-3.4.1/css/bootstrap.min.css" data-type="keditor-style" />-->
<!--        <link rel="stylesheet" type="text/css" href="../Views/Dash/theme/plugins/font-awesome-4.7.0/css/font-awesome.min.css" data-type="keditor-style" />-->
...
<!--<!--<!--    -->-->-->
<!--        <link rel="stylesheet" type="text/css" href="../Views/Dash/theme/plugins/code-prettify/src/prettify.css" />-->
...
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/jquery-1.11.3/jquery-1.11.3.min.js"></script>-->
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/bootstrap-3.4.1/js/bootstrap.min.js"></script>-->
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>-->
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/ckeditor-4.11.4/ckeditor.js"></script>-->
...
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/code-prettify/src/prettify.js"></script>-->
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/js-beautify-1.7.5/js/lib/beautify.js"></script>-->
<!--<script type="text/javascript" src="../Views/Dash/theme/plugins/js-beautify-1.7.5/js/lib/beautify-html.js"></script>-->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Views/Dash/theme/plugins/code-prettify/src/prettify.css" />
    <link rel="stylesheet" type="text/css" href="../Views/Dash/theme/dist/assets/js/examples.js" />
</head>
...
<div class="container my-3">
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                <input type="checkbox" name="comment" id="comment" <?php if(isset($option)){ echo "checked" ; }  ?>> Add comment section
            </div>
        </div>
    </div>
</div>
            ...
            if (newTitle !== "Title") {
                $.ajax({
                    ...
                    success: function (data) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Your page is officially created',
                ...
                Swal.fire({
                    icon: 'info',
                    title: 'OUPSS, something went wrong',
                    text: 'First, you have to change your title page!',
                    showConfirmButton: false,
                    timer: 1500
                });
            }
