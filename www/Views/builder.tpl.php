    ...
    <script>
        ...
        function createButtonEle(colSize = 12) {
            return $(
                `<div class='col-sm-${colSize} bg-white p-2 component'>
                    ${createDragHandle()}
                    <button class="btn btn-success btn-pb d-block mx-auto fontSelector">Click Me!</button>
                </div>'`
            );
        }
            ...
            return $(
                `
                    <div class='col-sm-${colSize} bg-white p-2 component'>
                        ...
                        <form>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label color-pb fontSelector">Email address</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                <div id="emailHelp" class="form-text color-pb fontSelector">We'll never share your email with anyone else.</div>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label color-pb fontSelector">Password</label>
                                <input type="password" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input color-pb fontSelector" id="exampleCheck1">
                                <label class="form-check-label color-pb fontSelector" for="exampleCheck1">Check me out</label>
                            </div>
                            <button type="submit" class="btn btn-primary btn-pb fontSelector">Submit</button>
                        </form>
                    </div>'`
            );
        }
